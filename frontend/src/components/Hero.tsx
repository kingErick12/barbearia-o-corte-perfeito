  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-20">
      ...
      <div className="relative z-20 px-8 lg:px-24 w-full flex flex-col justify-center animate-fade-in">
        <h2 className="text-[var(--color-primary)] text-4xl md:text-5xl font-serif tracking-widest mb-4 font-bold uppercase drop-shadow-md">
          Captain Barbearia.
        </h2>
        
        <h1 className="text-6xl md:text-8xl font-bold text-white mb-8 leading-tight max-w-2xl drop-shadow-xl">
          Estilo. Tradição. Qualidade.
        </h1>
        
        <p className="text-xl md:text-2xl text-[var(--color-textSc)] mb-12 max-w-xl font-light">
          Agende seu horário online e transforme seu visual.
        </p>

        <button 
          onClick={onOpenModal} 
          className="btn-gold group relative overflow-hidden w-fit transform hover:scale-105 tracking-wider uppercase"
        >
